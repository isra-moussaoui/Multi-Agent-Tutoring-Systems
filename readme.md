...
Target Output
 ...
 arXiv preprint
References
Confirming Correct, Missing the Rest: LLM Tutoring Agents Struggle Where Feedback Matters Most — BEA 2026 Workshop, EACL
Sycophancy is an Educational Safety Risk: Why LLM Tutors Need Sycophancy Benchmarks — arXiv:2605.14604
Why Do Multi-Agent LLM Systems Fail? — Cemri et al., arXiv:2503.13657
Risk Analysis Techniques for Governed LLM-based Multi-Agent Systems — Reid et al., arXiv:2508.05687
LangGraph Documentation — Multi-Agent Supervisor Pattern
ISIMM — Institut Supérieur d'Informatique et de Mathématiques de Monastir, University of Monastir, Tunisia
